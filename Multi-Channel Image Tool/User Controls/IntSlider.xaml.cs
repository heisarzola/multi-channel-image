...
namespace Multi_Channel_Image_Tool.User_Controls
{
    public partial class IntSlider : UserControl
    {
        ...
        private void OnSliderValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e) => UpdateValueLabel();
        private void OnTextBoxValueChanged(object sender, TextChangedEventArgs e) => ValidateValues();
    }
}
